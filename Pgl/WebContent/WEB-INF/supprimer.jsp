...
<head>
		<meta charset="utf-8">
		<title>AppData - Supprimer mon compte</title>
        <!-- icone site -->
...
<body>
        <header class="container-fluid header">
 		...
 		<section class="container-fluid inscription-done ">
			<h1 style="text-align:center">Supprimer votre compte</h1>   
		</section>
		<section class="container-fluid connexion">
		   <form action="/Pgl/supprimer" id="contact" method="post" class="form" role="form">
			    <div class="row">
				    ...
				    <div class="col-xs-6 col-md-6 form-group form-supp">
				         ...
				         <input class="form-control css-supp" id="password" name="password" placeholder="Mot de passe" type="password" />	 
